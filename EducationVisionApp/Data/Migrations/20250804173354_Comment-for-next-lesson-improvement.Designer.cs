...
namespace EducationVisionApp.Data.Migrations
{
    ...
    [Migration("20250804173354_Comment-for-next-lesson-improvement")]
    partial class Commentfornextlessonimprovement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EducationVisionApp.Domain.Entities.Lesson", b =>
                {
                    ...
                    b.Property<string>("CommentForNextTeacher")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EducationVisionApp.Domain.Entities.UserLesson", b =>
                {
                    ...
                    b.Property<int>("TotalBlinkCount")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TotalHeadTurn")
                        .HasColumnType("INTEGER");
